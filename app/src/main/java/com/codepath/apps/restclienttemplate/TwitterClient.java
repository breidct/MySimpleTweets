...
public class TwitterClient extends OAuthBaseClient {
	...
	public void getHomeTimeline2(long max_id,AsyncHttpResponseHandler handler){
		String apiUrl = getApiUrl("statuses/home_timeline.json");
		RequestParams params = new RequestParams();
		params.put("count", "25");
	...
	public void unreTweet(long uid, AsyncHttpResponseHandler handler){
		String apiUrl = getApiUrl("statuses/unretweet/" +String.format("%d",uid)+ ".json");
...
//	public void tweetStats(long uid,AsyncHttpResponseHandler handler){
